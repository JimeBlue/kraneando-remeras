...
export default defineAppConfig({
  ui: {
    ...
    dropdownMenu: {
      slots: {
        content: 'bg-transparent border border-transparent shadow-none text-white',
        item: 'text-white before:bg-transparent data-[state=open]:before:bg-transparent data-highlighted:text-primary-500',
      },
    },
    modal: {
      slots: {
